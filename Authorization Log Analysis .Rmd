...
ATO__Agencies_SaaS_Count <- Authorization_Log %>%
  group_by(Authorizing_Agency) %>% #grouping by Authorizing_Agency
...
list_of_datasets <- list("Cleaned" = `Authorization_Log`, 
                         ...
                         "ATO_Year_SM_Initial_Count" = `ATO_Year_SM_Initial_Count`, 
                         "ATO_Year_SM_Active_Initial_Count" = `ATO_Year_SM_Active_Initial_Count`,
                         "ATO_2018_SM_Active_Initial_Count" = `ATO_2018_SM_Active_Initial_Count`,
                         ...
                         "ATO_Active_Agencies_Count" = `ATO_Active_Agencies_Count`,
                         "ATO_InitialReuse_Active_Agencies_Count" = `ATO_InitialReuse_Active_Agencies_Count`, 
                         "ATO__Agencies_SaaS_Count" = `ATO__Agencies_SaaS_Count`, 
                         "ATO_Year_SM_InitialReuse_Count" = `ATO_Year_SM_InitialReuse_Count`, 
                         "ATO_Year_SM_Active_InitialReuse_Count" = `ATO_Year_SM_Active_InitialReuse_Count`,
